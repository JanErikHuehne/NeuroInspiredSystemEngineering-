...
void loop() {
  ...
  //FOR THE SENSORS 
  packetHandler->read2ByteTxRx(portHandler, dxl_new_id, DMS_1 , (uint8_t*)&DMS1, &dxl_error);
  packetHandler->read2ByteTxRx(portHandler, dxl_new_id, DMS_2, (uint8_t*)&DMS2, &dxl_error);
  packetHandler->read2ByteTxRx(portHandler, dxl_new_id, DMS_3, (uint8_t*)&DMS3, &dxl_error);
  packetHandler->read2ByteTxRx(portHandler, dxl_new_id, DMS_4, (uint8_t*)&DMS4, &dxl_error);
