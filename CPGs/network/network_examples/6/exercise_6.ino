...
void initializeNeuron(struct MatsuokaNeuron *neuron, int numberNeurons) {
        ...
        neuron->ode_solver = test_ode_solver_RK2;
    }
...
// ...
    ...
    initializeNeuron(&myNeuron11, numberNeurons);
    initializeNeuron(&myNeuron12, numberNeurons);
    initializeNeuron(&myNeuron13, numberNeurons);
    initializeNeuron(&myNeuron14, numberNeurons);
    initializeNeuron(&myNeuron15, numberNeurons);
    initializeNeuron(&myNeuron16, numberNeurons);
    initializeNeuron(&myNeuron17, numberNeurons);
    initializeNeuron(&myNeuron18, numberNeurons);
    initializeNeuron(&myNeuron19, numberNeurons);
    initializeNeuron(&myNeuron20, numberNeurons);
