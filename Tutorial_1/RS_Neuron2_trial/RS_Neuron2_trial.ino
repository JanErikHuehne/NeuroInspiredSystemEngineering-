...
Pattern OSCILLATORY2F={4.6,1.5,0.1,1};
...
setup_RS_neurons(&rs_neuron[2],ALMOSTOSC,"Third neuron");
setup_RS_neurons(&rs_neuron[3],OSCILLATORY2F,"Third neuron");
/*setup_RS_neurons(&rs_neuron[3],QUIESCENT,"Fourth neuron");
setup_RS_neurons(&rs_neuron[4],OSCILLATORY2F,"Fiftht neuron");*/
